...
here()
#if run in RStudio use this command and adjust directory:
...
for (case_study in case_studies){
  ...
  save(tuned_models, file=paste0(dir,"output/transform/tuned_models.rdata"))
  ...
  save(best_params_lgb, file=paste0(dir,"output/transform/tuned_lgb.rdata"))
  ...
  save(best_params_ctb, file=paste0(dir,"output/transform/tuned_ctb.rdata"))
